...
type Props = {
  entry: CollectionEntry<"blog"> | CollectionEntry<"projects"> | CollectionEntry<"achievements">
  pill?: boolean
}
        ...
        <div class="flex flex-wrap items-center gap-2">
          {pill &&
            <div class="text-sm capitalize px-2 py-0.5 rounded-full border border-black/15 dark:border-white/25">
              {entry.collection === "blog" ? "post" : entry.collection === "projects" ? "project" : "achievement"}
            </div>
          }
          <div class="text-sm">
