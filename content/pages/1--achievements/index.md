...
organized by Shopee. 
This is my first time participating in a data science competition. 
...
We build [Patrons](/patrons), a new way to visualize and display financial data by providing 
personalized virtual experience monitoring using Virtual Reality technology.
My team was selected as the top 10 in this hackathon.

---

### Facebook F8 Hackathon 2018
Shortlisted and got a free trip sponsored by Facebook 
...
My team developed a game chatbot [Clovero](/clovero), an Indonesian culture themed 
word guessing game. Clovero is selected as one of the top 50 chatbots in this competition.
...
Competed with around 2000 teams and was selected as one of the top 4 teams (for Blockchain category) 
to present our idea in the final event of UnitedByHCL Hackathon, a global hackathon held by 
Manchester United and HCL Technologies in Manchester. 
In this event, my team built [Comet](/comet), an offline payment solution that leverages 
...
My team was awarded the 2nd winner in this competition. 
In this hackathon, we built the second version of [Ceki](/ceki).

---

### AirAsia Airvolution Hackathon 2017
AirAsia Airvolution Hackathon 2017 is the first hackathon from [AirAsia](https://www.airasia.com).
My team was selected to represent Indonesia to compete with the other 20 teams from 
Southeast Asia countries in this hackathon. 

---

### Bank Rakyat Indonesia Hackathon 2016
My team was selected as one of the top 10 teams with our project [Ceki](/ceki), 
...
My team built a city reporting system and selected as a finalist.
...
This time my team won the 2nd place for Business Game Category. 
